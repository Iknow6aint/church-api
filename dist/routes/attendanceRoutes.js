 ...
 */
router.post('/', attendanceController_1.attendanceController.markAttendance);
/**
 * @swagger
 * /attendance:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/', attendanceController_1.attendanceController.getAttendanceByDate);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:contactId', attendanceController_1.attendanceController.getAttendanceByContact);
/**
 * @swagger
 * /attendance/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.get('/stats/:date', attendanceController_1.attendanceController.getAttendanceStats);
