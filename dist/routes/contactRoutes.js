 ...
 *         description: Internal server error
 */
router.get('/first-timers', contactController_1.contactController.getFirstTimers);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/by-evangelist/:evangelistName', contactController_1.contactController.getContactsByEvangelist);
/**
 * @swagger
 * /contacts/search:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/search', contactController_1.contactController.searchContacts);
/**
 * @swagger
 * /contacts/filter:
 *   post:
